...
const DashboardCharts: React.FC = () => {
    ...
    const topPerformers = [
        { name: 'Nguyễn Văn A', sales: 12, revenue: '8.5 tỷ', avatar: 'A' },
        { name: 'Trần Thị B', sales: 10, revenue: '6.2 tỷ', avatar: 'B' },
        { name: 'Lê Văn C', sales: 8, revenue: '5.8 tỷ', avatar: 'C' },
        { name: 'Phạm Thị D', sales: 7, revenue: '4.9 tỷ', avatar: 'D' },
    ];
                            ...
                            {recentProjects.map((project, index) => (
                                <ListItem key={index} sx={{ px: 0, py: 1 }}>
                                    <ListItemText
                                        ...
                                        secondary={`${project.progress}% - Doanh thu: ${project.revenue}`}
                                    />
                                    <Chip
